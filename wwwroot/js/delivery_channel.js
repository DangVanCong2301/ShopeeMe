...
function setDataOrderDetail(data) {
    ...
    if (data.orderDetails.length != 0) {
        ...
        `
                    <div class="phone-pickup__order">
                        ...
                        if (data.ordersDelivering[0].fK_iOrderStatusID == 7) {
                            htmlOrderDetail += 
                            `
                            ...
                            `;    
                        } else if (data.ordersDelivering[0].fK_iOrderStatusID == 8) {
                            htmlOrderDetail += 
                            `
    ...
    if (data.orderDetails.length != 0) {
        ...
        document.querySelector(".phone-header__delivering-order-detail-arrow").addEventListener('click', () => {
            openDeliveringOrderListTab(data);
        });
    }                   
}
